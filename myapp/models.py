...
class Irregular(models.Model):
    texto=models.ForeignKey(ElegirRespuesta, on_delete=models.CASCADE, related_name='Irregulares')
...
class Prueba_regular(models.Model):                                                                                                                                       
    texto=models.ForeignKey(ElegirRespuesta, on_delete=models.CASCADE, related_name='Pruebas_regulares')
    past=models.CharField(max_length=50)
    participe=models.CharField(max_length=50)
    gerundio=models.CharField(max_length=50)
...
class tiempoverbal(models.Model):
    texto = models.ForeignKey(ElegirRespuesta, on_delete=models.CASCADE, related_name='tiempos_verbales')
    past = models.CharField(max_length=50)
    participe=models.CharField(max_length=50)
    gerundio=models.CharField(max_length=50)
